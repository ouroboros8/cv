...
\textbf{Nov 2015 -- Nov 2016}       & \textbf{DevOps Support Engineer} at HM Revenue \& Customs \\
                                    & \emph{London, UK} \\
                                    & \footnotesize
    {Supporting HMRC's Multi-channel Digital Tax Platform.
    \begin{itemize}
        \item Streamlined incident response and resolution by establishing a
        triage rota and work-in-progress limits, resulting in the elimination
        of a large backlog which had fluctuated between 20 and 60 tickets since
        I joined.
        \item Established proactive monitoring of release-critical
        pre-production environments.
        \item Implemented predictive monitoring for simple trends like disk
        usage.
    \end{itemize}
    }\\
